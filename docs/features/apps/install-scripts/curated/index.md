...
| `minecraft` | [minecraft.json](/install-scripts/minecraft.json) | 460 B | 2025-11-21 |
| `plex` | [plex.json](/install-scripts/plex.json) | 3.1 KB | 2025-11-21 |
| `postgres` | [postgres.json](/install-scripts/postgres.json) | 716 B | 2025-11-21 |
| `prowlarr` | [prowlarr.json](/install-scripts/prowlarr.json) | 443 B | 2025-11-21 |
| `qbittorrent` | [qbittorrent.json](/install-scripts/qbittorrent.json) | 883 B | 2025-11-21 |
...
| `wg-easy` | [wg-easy.json](/install-scripts/wg-easy.json) | 317 B | 2025-11-21 |
<!-- curated:index:end -->
