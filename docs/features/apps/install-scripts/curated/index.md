...
|---|---|---:|---|
| `bazarr` | [bazarr.json](/install-scripts/bazarr.json) | 1.3 KB | 2025-12-23 |
| `drawio` | [drawio.json](/install-scripts/drawio.json) | 739 B | 2025-12-23 |
| `emby` | [emby.json](/install-scripts/emby.json) | 2.2 KB | 2025-12-23 |
| `handbrake` | [handbrake.json](/install-scripts/handbrake.json) | 1.8 KB | 2025-12-23 |
...
| `lidarr` | [lidarr.json](/install-scripts/lidarr.json) | 1.3 KB | 2025-12-23 |
| `nextcloud` | [nextcloud.json](/install-scripts/nextcloud.json) | 3.4 KB | 2025-12-23 |
| `peanut` | [peanut.json](/install-scripts/peanut.json) | 823 B | 2025-12-23 |
...
| `scrutiny` | [scrutiny.json](/install-scripts/scrutiny.json) | 1.2 KB | 2025-12-23 |
| `sonarr` | [sonarr.json](/install-scripts/sonarr.json) | 1.2 KB | 2025-12-04 |
| `syncthing` | [syncthing.json](/install-scripts/syncthing.json) | 2.0 KB | 2025-12-23 |
<!-- curated:index:end -->
