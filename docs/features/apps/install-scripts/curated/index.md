...
| `collabora` | [collabora.json](/install-scripts/collabora.json) | 3.2 KB | 2026-03-17 |
...
| `onlyoffice` | [onlyoffice.json](/install-scripts/onlyoffice.json) | 2.4 KB | 2026-03-17 |
| `opencloud` | [opencloud.json](/install-scripts/opencloud.json) | 5.9 KB | 2026-03-17 |
