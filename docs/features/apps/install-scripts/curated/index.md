...
| `immich` | [immich.json](/install-scripts/immich.json) | 2.0 KB | 2025-11-04 |
| `jellyfin` | [jellyfin.json](/install-scripts/jellyfin.json) | 2.4 KB | 2025-11-04 |
| `minecraft` | [minecraft.json](/install-scripts/minecraft.json) | 460 B | 2025-08-20 |
| `plex` | [plex.json](/install-scripts/plex.json) | 2.3 KB | 2025-11-04 |
