...
- **New website and ecommerce experience** to support subscription pricing when we sunset the current Early Access price.  We have no intention of removing the lifetime license, but the Early Access price point will increase over time.  Once the current price is gone, it is gone forever.  If you have been on the fence, now is the time.
