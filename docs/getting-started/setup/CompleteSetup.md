...
Your server should appear in the panel where it says "Looking for servers..." on the right of the screen.  Click the purple Claim button.
...
If you see green checks/ticks on everything then you're good to go. Click the purple Continue button.
