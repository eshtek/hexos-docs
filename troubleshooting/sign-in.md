...
3. **Browser issues**
   - Try clearing your browser cache and cookies ([detailed instructions](/troubleshooting/browser-cache))
...
**Related:** [Clear browser cache](/troubleshooting/browser-cache) — fix login and UI problems caused by stale browser data
