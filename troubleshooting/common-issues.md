...
- [**Application Errors**](https://docs.hexos.com/en/troubleshooting/common-issues/ApplicationErrors) - Troubleshooting app installation, updates, and startup issues
- [**Avoid USB Drives**](https://docs.hexos.com/en/troubleshooting/common-issues/AvoidUSBDrives) - Why USB drives can cause issues and what to use instead
- [**Clear Browser Cache**](https://docs.hexos.com/en/troubleshooting/common-issues/ClearCache) - Fix login issues and UI problems by clearing your browser cache
