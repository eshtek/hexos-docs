...
- Installation buttons will correctly link to the appropriate actions now even when there are inconsistencies between TrueNAS's app catalog appId and appName.
