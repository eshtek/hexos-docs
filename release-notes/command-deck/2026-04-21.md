...
- Added warnings when a server is running a TrueNAS version too old for full HexOS compatibility (Supported: >=24.10.2.2, <26.0.0).  Early adopters still on 24.10.0 or 24.10.2.1 will need to upgrade manually.  Follow our [upgrade guide](/troubleshooting/common-issues/upgrading-hexos-truenas-24-to-truenas-25).
