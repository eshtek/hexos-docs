...
<details>
<summary> HexOS Q2 update overview </summary>

![1.png](/blog/9-30/1.png){.medium .framed}
</details>

## Manual Pool Configuration

Users now have far more control over [pool creation](/features/storage). During setup, you can use HexOS' recommended storage layout, adjust it to your needs, or skip it entirely and handle it later at your convenience. This process extends beyond the initial server setup and into your main storage page, so you can configure it at your convenience.

<details>
<summary> Manual pool configuration </summary>

![2.png](/blog/9-30/2.png){.medium .framed}
</details>
...
![0.png](/blog/9-30/0.png){.medium .framed} ![3.png](/blog/9-30/3.png){.medium .framed}
All activities are also available in the archive for a complete record of what's happening on your server.

<details>
<summary> Activity archive </summary>

![4.png](/blog/9-30/4.png){.medium .framed}
</details>

## TrueNAS SCALE 24.10.2.2 Update

With notifications redesigned, and a new activity center, users now have the ability to update the OS on your local server itself. These types of updates will always propagate to the top so you don't miss them.
...
<details>
<summary> Custom app location preferences </summary>

![5.png](/blog/9-30/5.png){.medium .framed}
</details>
...
![6.png](/blog/9-30/6.png){.medium .framed}
</details>
